...
CREATE TABLE `bankcard` (
  ...
  PRIMARY KEY (`bcid`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='银行卡表';
...
CREATE TABLE `borrowapply` (
  ...
  PRIMARY KEY (`baid`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='申请借款表';
...
CREATE TABLE `borrowdetail` (
  ...
  PRIMARY KEY (`bdid`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='借款详情表';
...
CREATE TABLE `hkb` (
  ...
  PRIMARY KEY (`skid`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='还款表';
...
-- Records of huser
-- ----------------------------
INSERT INTO `huser` VALUES ('46', '李四', '男', '15087654321', 'superadmin', 'admin@gmail.com', '2018-01-09 08:56:30', 'Qpf0SxOVUjUkWySXOZ16kw==');
INSERT INTO `huser` VALUES ('48', '张三', '女', '15012345678', 'admin', 'admin@qq.com', '2018-01-20 09:38:45', 'Qpf0SxOVUjUkWySXOZ16kw==');
INSERT INTO `huser` VALUES ('49', 'abc', '男', '13012344321', 'abc', 'abc@qq.com', '2018-01-20 10:20:31', '4QrcOUm6Wau+VuBX8g+IPg==');
...
CREATE TABLE `money_log` (
  ...
  `date` datetime DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='资金流向表';
...
CREATE TABLE `recommend` (
  ...
  `date` datetime DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`rid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='推荐管理表';
...
INSERT INTO `role` VALUES ('29', '普通员工', '无', '2018-01-20 09:50:10');
...
CREATE TABLE `roleuser` (
  ...
  PRIMARY KEY (`ruid`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='用户角色表';
...
INSERT INTO `roleuser` VALUES ('115', '29', '49');
...
CREATE TABLE `rzvip` (
  ...
  PRIMARY KEY (`rid`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='认证表';
...
CREATE TABLE `rzvip_check` (
  ...
  `date` datetime DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`rcid`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='认证审核表';
...
CREATE TABLE `shborrow` (
  ...
  `baid` int(11) DEFAULT NULL COMMENT '借款id',
  PRIMARY KEY (`shid`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='借款审核表';
...
CREATE TABLE `tx_check` (
  ...
  `date` datetime DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`rcid`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='提现审核表';
...
CREATE TABLE `tx_log` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='提现记录表';
...
CREATE TABLE `tzb` (
  ...
  `baid` int(11) DEFAULT NULL COMMENT '借款id',
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='投资表';
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`uid`),
  UNIQUE KEY `phone` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=100012 DEFAULT CHARSET=utf8 COMMENT='前台用户表';
...
CREATE TABLE `usermoney` (
  ...
  PRIMARY KEY (`umid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='用户资金表';
...
CREATE TABLE `user_ticket` (
  ...
  PRIMARY KEY (`rwid`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='领券表';
